...
class MainActivity : AppCompatActivity() {
    ...
    private fun converter(){
        val selectedCurrency = findViewById<RadioGroup>(R.id.radio_grup)
        ...
        Thread {
            ...
            val url = URL("https://free.currconv.com/api/v7/convert?q=${currency}_BRL&compact=ultra&apiKey=1a95d4677cb69f3aefc8")
